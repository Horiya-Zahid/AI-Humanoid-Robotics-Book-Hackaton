...
const config: Config = {
  ...
  url: 'https://aihumanoidroboticsbook.vercel.app/',
      ...
      links: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              to: '/docs/module-1-robotic-nervous-system/week-1',
            },
            {
              label: 'Module 2: Digital Twin',
              to: '/docs/module-2-digital-twin/week-6',
            },
            {
              label: 'Module 3: AI-Robot Brain',
              to: '/docs/module-3-isaac-brain/week-8',
            },
            {
              label: 'Module 4: VLA Capstone',
              to: '/docs/module-4-vla-capstone/week-11',
            },
          ],
        },
        {
